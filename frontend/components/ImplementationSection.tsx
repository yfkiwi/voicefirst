            ...
            <div className="p-4 bg-stone-50 rounded-lg border-2 border-dashed border-stone-300">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Input placeholder="Milestone (e.g., Complete facility construction)" className="flex-1 bg-white" />
                  <Input type="date" className="w-40 bg-white" />
                </div>
                <div className="flex items-center gap-3">
                  <Input placeholder="Milestone (e.g., Launch training program)" className="flex-1 bg-white" />
                  <Input type="date" className="w-40 bg-white" />
                </div>
                <div className="flex items-center gap-3">
                  <Input placeholder="Milestone (e.g., First product sales)" className="flex-1 bg-white" />
                  <Input type="date" className="w-40 bg-white" />
                </div>
              </div>
            </div>
